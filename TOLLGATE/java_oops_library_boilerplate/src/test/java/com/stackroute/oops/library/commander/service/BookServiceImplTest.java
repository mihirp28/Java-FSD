package com.stackroute.oops.library.commander.service;
...
public class BookServiceImplTest {
    private static final String MESSAGE_ONE = "BookServiceImpl should be initialized with an empty LinkedList properly";
    ...
    public static void setUp() throws Exception {
        ...
        book1 = new Book("001", "Dracula", "Shradha", 300);
        book2 = new Book("002", "Kite", "Neha", 120);
    }
    ...
    @Test
    @Order(3)
    public void givenBookDataWithAuthorLength4c() throws BookAlreadyExistsException {
    ...
    public void givenNonExistingOrEmptyBookIdThenThrowException() {
        assertThrows(BookNotFoundException.class, () -> bookService.findBook("003", BOOK_FILE_NAME), MESSAGE_THREE);
