...
public interface BookRepository extends JpaRepository<Book, Integer> {
	...
	/*
	 * Define a method to get book by author id and book published date, returning
	 * an Optional of book
	 */
	// findBookByAuthorIdAndBookPublishedDate(String authorId, LocalDate
	// bookPublishedDate);
	 ...
	 */
	// findBookByAuthorId(String authorId);
	 List<Book> findBookByAuthorId(String authorId);
	/*
	 * Define a method to get all books by library id and book published date,
	 * returning list of books
	 */
	// findBookByLibraryIdAndBookPublishedDate(String libraryId, LocalDate
	// bookPublishedDate);
